...
urlpatterns = [
    ...
    path('survey_detail/<int:id>/<int:assesment_id>', views.survey_detail, name='survey_detail'),
    ...
    path('questionForSurvey/<int:id>/<int:assesment_id>' , views.questionForSurvey , name = 'questionForSurvey'),
